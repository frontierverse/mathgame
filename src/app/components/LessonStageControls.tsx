      ...
      {lessonId === "powers" && powersStage === 0 && (
        <div className="absolute bottom-5 left-1/2 z-20 flex -translate-x-1/2 gap-3">
          <button
            type="button"
            disabled
            className="rounded-xl border border-[#b9add2] bg-[#f7f3fb] px-5 py-3 text-sm font-bold text-[#685c76] shadow-[0_4px_0_#d8cfe3] disabled:cursor-not-allowed disabled:opacity-35"
          >
            이전
          </button>
          <button
      ...
      {lessonId === "triangle-area" && triangleAreaStage === 0 && (
        <div className="absolute bottom-5 left-1/2 z-20 flex -translate-x-1/2 gap-3">
          ...
          <button
            ...
            className="rounded-xl border border-[#8f78c6] bg-[#f8f3ff] px-5 py-3 text-sm font-bold text-[#594572] shadow-[0_4px_0_#c9bce4] transition hover:-translate-y-0.5 hover:bg-white active:translate-y-0"
          >
            사각형 생각하기
          </button>
        </div>
